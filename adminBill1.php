...
<nav class="navbar navbar-expand-lg navbar-black bg-black py-3 shadow-sm bg-transparent-black fixed-top"> <a href="#" class="navbar-brand font-weight-bold d-block d-lg-none"></a>
    ...
    <div id="navbarContent" class="collapse navbar-collapse">
		...
		<a id="megamneu" href="adminviewdelvery.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link  font-weight-bold text-uppercase ">BACK</a></li>  
...
?>          </td>
        ...
        <tr>
		  ...
		  <span class="auto-style7">Your Order in Delivery!<br></span><br>
		  <span class="auto-style8">Thank You For Choose</span><br class="auto-style8">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
		  ...
		  <span class="auto-style9">process</span> of delivering books to your door
