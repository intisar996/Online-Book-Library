...
<body>
 ...
 <table align="center" cellpadding="2" style="width: 424px; height: 134px">
			<tr>
				<td class="auto-style11" colspan="2" style="height: 10px">
				<h2 class="auto-style10"><strong>ADD BOOK TYPE</strong></h2>
				</td>
			</tr>
			<tr>
				<td class="auto-style9" style="height: 38px; width: 396px">
				<span class="auto-style21">Book Type</span>:&nbsp; </td>
				<td class="auto-style9" style="height: 38px; width: 190px">
				<input id="typ_name" class="form-control" name="typ_name" style="width: 221px; height: 38px" type="text"></td>
			</tr>
			<tr>
				<td class="auto-style9" style="height: 38px; width: 396px">
				Image</td>
			...
			<tr>
				...
				<input name="Submit1" style="width: 86px; font-weight: bold; font-size: medium; height: 35px;" type="submit" value="ADD" class="input btn-outline-danger" /><span class="auto-style12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</span>
