...
while($row = mysqli_fetch_assoc($result)) {
    $typ_ide=$row['typ_id'];
     $typ_name = $row['typ_name'];
      ...
      echo"<h4 class='title' colspan='8'><a href='bookviewform.php?typ_id=$typ_ide&&typ_name=$typ_name'><font face ='Arial' size = 2>$typ_name</a></font></span>";
      echo" </div>";
       echo" </div>";
   ...
   echo" <div class='card card-profile' align='center'>";
             echo" <div class='row' align='center'>";
                    ...
                    echo"<div class='content pull-left'>";
                     echo"<h4><font  size ='2'>$book_id</font>";

                        echo"<h4><font  size ='2'>$book_name</font>";
                       echo"<h4><font  size ='2' color='#A52834'>QUANTITY:</font><font  size ='3' color='#000000'> $quantity</font>";
                       echo"<h4><font  size ='2' color='#A52834'> TYPE:</font><font  size ='3' color='#000000'> $typ_name</font>";

                        echo"<p><span><font color='#DC3545' Size='3'>$book_price</span>-OMR</font></p>";
                       echo"<a href ='bookdetailes.php?book_id=$book_id&&book_name=$book_name'><input type='button' value='More' class='btn btn-info'></button></a>";
...
?>
 ...
 <?php 
                ...
                if($page>1)
                {
                    echo "<a href='viewbook.php?page=".($page-1)."' class='btn btn-secondary'>Previous</a>";
                }

                
                for($i=1;$i<$total_page;$i++)
                {
                    echo "<a href='viewbook.php?page=".$i."' class='btn btn-info'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='viewbook.php?page=".($page+1)."' class='btn btn-secondary'>Next</a>";
                }
