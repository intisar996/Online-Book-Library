...
$q= "Select * from tbcustomer a,tblbill b where b.orderid='$orid' and  a.cusername=b.cusername  ";
...
echo "<br>";
	...
	echo "<tr bgcolor='#A52834'> ";
		...
		echo "<td   width=100 align=center  colspan=9><font color='#ffffff'> Payment Details</font></td>";
	echo"</tr>";

echo"<th class='col-1'><font face = arial size =2>Order ID";
echo"<th class='col-3'><font face = arial size =2>CUSTOMER NAME";
echo"<th class='col-3'><font face = arial size =2>CUSTOMER USERNAME ";
echo"<th class='col-3'><font face = arial size =2>CUSTOMER ADDRESS";
echo"<th class='col-5'><font face = arial size =2>CARD NAME";
echo"<th class='col-5'><font face = arial size =2>CARD NMBER";
echo"<th class='col-5'><font face = arial size =2>CARD EXPIRE DATE";
echo"<th class='col-5'><font face = arial size =2>TOTAL AMOUNT";
...
$vcardname =$row['cardname'];
$vcardnum = $row['cardnum'];
$vdateexp = $row['dateexp'];
$vtotalamount = $row['totalamount'];
$vcid =$row['cid'];


echo"<tr>";
echo"<td align =center><font face = arial size =2>$vorid";
echo"<td><font face = arial size =2>$vcname ";
echo"<td><font face = arial size =2>$vusernamerc";
echo"<td align =center><font face = arial size =2>$vcaddress";
echo"<td align =center><font face = arial size =2>$vcardname";
echo"<td align =center><font face = arial size =2>$vcardnum";
echo"<td align =center><font face = arial size =2>$vdateexp";
echo"<td align =center><font face = arial size =2>$vtotalamount";


echo"<td ><a href='customerOrder.php?cusername=$vusernamerc&&cid=$vcid'>BACK</a>";
