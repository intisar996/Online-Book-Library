...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-black bg-black py-3 shadow-sm bg-transparent-black fixed-top"> <a href="#" class="navbar-brand font-weight-bold d-block d-lg-none"></a>
	...
	$query1 = "select * from placeorder a ,tblbill b where a.orid=b.orderid and  a.Payment='Yes' and  a.orderstatus='delivered' order by orderdate LIMIT  $start_from,$num_per_page ";
	...
	echo "<th colspan = 1 ><font face =arial size =2>OPTIONS";
     ...
     while($row = mysqli_fetch_assoc($result1)) {
		...
		echo "<td align=center><a href='adminBill2.php?orid=$rno&&bill_id=$bill_id&&cusername=$usernamerc'><font face =arial size =2>VIEW BILL</a><br>";
