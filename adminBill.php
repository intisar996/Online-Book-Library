...
<nav class="navbar navbar-expand-lg navbar-black bg-black py-3 shadow-sm bg-transparent-black fixed-top"> <a href="#" class="navbar-brand font-weight-bold d-block d-lg-none"></a>
    ...
    <div id="navbarContent" class="collapse navbar-collapse">
		...
		<a id="megamneu" href="adminvieworder.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link  font-weight-bold text-uppercase ">BACK</a></li>  
 ...
 <div class="text_align_center">
	...
	$query1 = "select * from tblbill  where bill_id='$bill_id' ";
      $result = mysqli_query($con,$query1);
      while($row = mysqli_fetch_assoc($result)) {
	$bill_id=$row["bill_id"];
	}
...
?>
      ...
      <table align="center" bgcolor="FFFFFF" style="height: 425px; width: 584px;">
        ...
        <tr>
          <td bgcolor="FFFFFF" scope="row" class="auto-style3" style="width: 175px">
             <strong><span class="auto-style6">Bill ID 
          </span></strong> 
          </td>
          <td bgcolor="FFFFFF" style="width: 203px" class="auto-style3">
            <strong><span class="auto-style6">ORDER DATE</span></strong></td>
          <td bgcolor="FFFFFF" class="auto-style3" style="width: 156px">
             <strong><span class="auto-style6">Bill
            Total</span></strong></td>
          <td bgcolor="FFFFFF" class="auto-style3">
            <strong><span class="auto-style6">STATUTS</span></strong></td>
        </tr>
        <tr>
          <td bgcolor="FFFFFF" scope="row" class="auto-style3" style="width: 175px"><?php 
			echo "<font face='Arial, Helvetica, sans-serif' size='3'>".$bill_id;
		 ?></td>
        ...
        <tr>
          <td bgcolor="FFFFFF" scope="row" class="auto-style3" style="width: 175px">
		  Customer Name:</td>
          <td bgcolor="FFFFFF" scope="row" class="auto-style3">  Phone Number:</td>
          <td bgcolor="FFFFFF" style="width: 156px" class="auto-style3">   
		  Email:</td>
          <td bgcolor="FFFFFF" class="auto-style3">     Address</td>
        </tr>
        ...
        <tr>
          <td colspan="4" bgcolor="#FFFFFF" scope="row" style="height: 116px" class="auto-style3">&nbsp;
          <?php
	include('connect.php');
  ...
  echo "<table  id='productSizes' class='table' border='3'  style='width:100%;' align=center  cellspacing=2>";
	echo"<th class='col-1'>ORDER ID </th>";
	echo"<th class='col-3'>Book ID </th>";
	echo "<th class='col-3'>Book  NAME</th>";
	echo "<th class='col-3'>Book  PRICE</th>";
	echo "<th class='col-5'>Quantity</th>";
	echo "<th class='col-3'>total price</th>";
		echo "<th class='col-5'>Book  PICTUER</th>";
...
?>          </td>
        ...
        <tr>
          <th colspan="4" bgcolor="#FFFFFF" scope="row" class="auto-style8">
		  <div class="text_align_center">
		  <span class="auto-style7">we will contact you when shipping your order</span><span class="auto-style6">.<br>
		  <br>
		  </span></div>
		  <span class="auto-style6">
		  <div class="text_align_center" style="height: 42px">
		  <span class="auto-style6">Thank You For Choose</span><br class="auto-style6">
             <span class="auto-style6">
          BOOK SHOP</span></div>
			</th>
        </tr>
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
		  ...
		  <span class="auto-style10">process</span> of delivering books to your door
