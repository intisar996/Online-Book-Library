  ...
  <nav class="navbar navbar-expand-lg navbar-black bg-black py-3 shadow-sm bg-transparent-black fixed-top"> <a href="#" class="navbar-brand font-weight-bold d-block d-lg-none"></a>
    ...
    <div id="navbarContent" class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown megamenu">
			<a id="megamneu" href="yourcart.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link  font-weight-bold text-uppercase"> SHOPPING CART</a>
			</li><li class="nav-item"><a href="myorder.php" class="nav-link font-weight-bold text-uppercase">MY ORDERS</a></li>
			<li class="nav-item"><a href="customerupdateprofile.php" class="nav-link font-weight-bold text-uppercase">PROFILE</a></li>
			<li class="nav-item"><a href="customerchangepassword.php" class="nav-link font-weight-bold text-uppercase">CHANGE PASSWORD</a></li>
	...
	?> 
               ...
               <div class="carousel-item active">
                ...
                <br/>
                <hr>
 <div class="text_align_center" style="height: 476px">
	 <br>
    <div class="auto-style5"> <span class="text text-center">Finding Best Book Now<br> in Our Website.</span> </div>
    <div class="row mt-2 g-4">



     <br><br>
	 <table style="width: 85%; height: 113px;" align="center" class="auto-style2">
		 <tr> <td style="width: 691" class="auto-style4"> 
    <?php
...
echo" <div class='row' colspan='1' align='center'>";

	echo"<table  id='services' class='services services' width='50px' border='2' cellpadding = '0' cellspacing = '0' bgcolor='#ffffff' >";
    echo"<tr  >";
...
while($row = mysqli_fetch_assoc($result)) {
    $typ_ide=$row['typ_id'];
     $cname = $row['typ_name'];
      ...
      echo"<tr>";
      echo"<div class='col-lg-1 col-4 icon-box' br ><br>";
      echo" <div class='circular'><img src ='image/$image'   class='img-fluid rounded-circle' width='150' height='150' ></img><br></div><br>";
      echo"<h4 class='title' colspan='8'><a href='bookviewform1.php?typ_id=$typ_ide&&typ_name=$cname'><font face ='Arial' size = 2>$cname</a></font></span>";
      echo" </div>";
       echo" </div>";
...
<tr> <td class="text_align_center" style="width: 691px">
...
$query = "Select * from  tblbbook  order by book_price LIMIT  $start_from,$num_per_page"; 

$result=mysqli_query($con,$query);
 $num= mysqli_num_rows($result);

$i = 0;  
echo" <div class='row' colspan='1' align='center'><br>";

    echo"<table  width ='40px' align ='center'>";
...
$row = mysqli_fetch_assoc($result);
  ...
  $image = $row['image'];
       ...
       echo" <div class='carousel-item active' align='center'>";
           echo" <td class='thumb-wrapper' align='center'>";
   echo" <div class='card card-profile' align='center'>";
             echo" <div class='row' align='center'>";

                    echo"<div class='img-box'>";
                      echo" <img src ='image/$image' class='img-fluid'  width='120' hight='120' >";
                    echo"</div>";
                    echo"<div class='content pull-left'>";
                        echo"<h4><font  size ='2'>$book_name</font>";
                        echo"<p><span><font color='#DC3545' Size='3'>$book_price</span>-OMR</font></p>";
                       echo"<a href ='bookdetailes1.php?book_id=$book_id&&book_name=$book_name'><input type='button' value='More' class='btn btn-info'></button></a>";
...
?>
 ...
 <?php 
                ...
                if($page>1)
                {
                    echo "<a href='customerhomepage.php?page=".($page-1)."' class='btn btn-secondary'>Previous</a>";
                }

                
                for($i=1;$i<$total_page;$i++)
                {
                    echo "<a href='customerhomepage.php?page=".$i."' class='btn btn-info'>$i</a>";
                }

                if($i>$page)
                {
                    echo "<a href='customerhomepage.php?page=".($page+1)."' class='btn btn-secondary'>Next</a>";
                }
