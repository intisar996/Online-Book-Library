          ...
          <h4 class="logo" style="color: #FFFFFF">BOOKS STORE</h4>
            ...
            <li class="nav-item dropdown megamenu"><a  href="index.php" class="nav-link  font-weight-bold text-uppercase ">HOME</a></li> 
               ...
               <div class="carousel-item active">
                  <img class="d-block w-100" src="image/download.jpg" alt="slider_img" height="589">
                  <div class="ovarlay_slide_cont" style="left: -2px; top: 135px; height: 302px">
...
$q="select * from  tbcustomer where cusername='$usernamerc'";
...
?>
 ...
 <form   method="post"  action="<?php echo "checkcustomeranswer.php?cusername=$usernamerc";?>" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data"  >
		<br />
