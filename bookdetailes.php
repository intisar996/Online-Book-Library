        ...
        <div class="row m-0">
            ...
            <div class="col-lg-8">
                <div class="right-side-pro-detail border p-3 m-0">
                    <div class="row">
                    <div class="col-lg-12">
                            <span><strong>ID:<?php echo "<font face ='Felix Titling' size ='3'>".$book_id ."</font>";?></strong></span>
                         </p>
                        </div>

                        <div class="col-lg-12">
                            <span><strong>Writer:<?php echo "<font face ='Felix Titling' size ='3'>".$book_writer ."</font>";?></strong></span>
                            <p><span><span class="auto-style2">Book Name:</span><strong><?php echo "<font face ='Felix Titling' size ='3' color='#000000'>".$book_name ."</font>";?></strong></span>
                        </p>
                        </div>
                        <div class="col-lg-12">
                  ...
                  <div class="col-lg-12">
                            <p class="tag-section"><strong>Book type : </strong><?php echo "<font face ='Imprint MT Shadow' size ='4'>".$book_type ."</font>";?></p>
                        </div>

                        <div class="col-lg-12 mt-3">
                            <div class="row">
                                <div class="col-lg-6 pb-2">
                                    <?php echo "<a href='updatebook.php?book_id=$book_id'>"?> <input  value="UPDATE" class="btn btn-secondary w-100"/> </a>
                                </div>
                                <div class="col-lg-6">
                              <?php echo "<a onClick=\"javascript: return confirm('Please confirm deletion');\" href='deletebook.php?book_id=$book_id'"?>
									<input  value="DELETE" class="btn btn-info w-100" style="color: #FFFFFF; height: 38px"/>DELETE</a>
