    ...
    <div id="navbarContent" class="collapse navbar-collapse">
        <ul class="navbar-nav mx-auto">
          <h4 class="logo" style="color: #FFFFFF">BOOKS STORE</h4>
			...
			<a id="megamneu" href="search.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link  font-weight-bold text-uppercase">BACK</a></li> 
...
?>
    ...
    <form id="form2" name="form2" method="post" action="<?php echo"updatebook_code1.php?book_id=$book_id" ;?>" onsubmit="return validate(this);">
