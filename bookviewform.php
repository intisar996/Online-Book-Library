...
while($row = mysqli_fetch_assoc($result)) {
    $typ_ide=$row['typ_id'];
     $cname = $row['typ_name'];
      ...
      echo"<h4 class='title' colspan='8'><a href='bookviewform.php?typ_id=$typ_ide&&typ_name=$cname'><font face ='Arial' size = 2>$cname</a></font></span>";
      echo" </div>";
       echo" </div>";
...
<tr> <td class="text-start" style="width: 691px">
 ...
 <button type="button" class="about-btn scrollto"  onclick="window.location.href ='viewbook.php';" style="width: 9%; height: 25px">
