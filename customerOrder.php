...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-black bg-black py-3 shadow-sm bg-transparent-black fixed-top"> <a href="#" class="navbar-brand font-weight-bold d-block d-lg-none"></a>
    ...
    <div id="navbarContent" class="collapse navbar-collapse">
		...
		<a id="megamneu" href="Viewcustomer.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link  font-weight-bold text-uppercase ">BACK</a></li>  
...
$q= "Select * from tbcustomer a,placeorder b where a.cusername='$usernamerc' and  a.cusername=b.cusername  order by orderdate ";
...
echo"<th class='col-1' border='3'><font face = arial size =2>Order ID";
echo"<th class='col-1' border='3'><font face = arial size =2>CUSTOMER NAME";
echo"<th class='col-3' border='3'><font face = arial size =2>CUSTOMER USERNAME ";
echo"<th class='col-3' border='3'><font face = arial size =2>CUSTOMER ADDRESS";
echo"<th class='col-3' border='3'><font face = arial size =2>ORDER DATE";
echo"<th class='col-5' border='3'><font face = arial size =2>STATUS";


echo"<th class='col-3' colspan ='1'  border='3'> Action";

echo"<tr>";

while($row = mysqli_fetch_assoc($r)) {
$vusernamerc =$row['cusername'];
$vorid=$row['orid'];
$vcname =$row['cname'];
$vorderDate =$row['orderdate'];
$vstatus = $row['orderstatus'];
$vcaddress =$row['caddress'];


echo"<tr>";
echo"<td align =center><font face = arial size =2>$vorid";
echo"<td border='3'><font face = arial size =2>$vcname ";
echo"<td border='3'><font face = arial size =2>$vusernamerc";
echo"<td  border='3' align =center><font face = arial size =2>$vcaddress";
echo"<td border='3' align =center><font face = arial size =2>$vorderDate";;
echo"<td   border='3' align =center><font face = arial size =2>$vstatus";




echo"<td ><a href='PaymentDetails.php?cusername=$usernamerc&&orid=$vorid'>View Payment Details</a>";
...
echo"</table><br>";
	...
	echo "<center>No Order Yet! <br>";
	echo "Click <a href='viewcustomer.php'>here</a> To Back !</a></center>";
}
