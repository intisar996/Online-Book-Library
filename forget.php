...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-black bg-black py-3 shadow-sm bg-transparent-black fixed-top"> <a href="#" class="navbar-brand font-weight-bold d-block d-lg-none"></a>
    ...
    <div id="navbarContent" class="collapse navbar-collapse">
        <ul class="navbar-nav mx-auto">
          <h4 class="logo" style="color: #FFFFFF">BOOKS STORE</h4>
            ...
            <li class="nav-item"><a href="login.php" class="nav-link font-weight-bold text-uppercase">LOGIN</a></li>
               ...
               <div class="carousel-item active">
                  <img class="d-block w-100" src="image/download.jpg" alt="slider_img" height="561">
                  <div class="ovarlay_slide_cont" style="left: -1px; top: 135px; height: 300px; bottom: 98px">
    ...
    <form   method="post" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data" action="checkuserusername.php">

 <table align="center" cellpadding="2" style="width: 349px" >
			<tr>	
				<td class="auto-style8">
						<img src="image/forget.png" height="86" width="95"></img></div>
            	<br />
				<span class="auto-style16">F<span class="auto-style12">ORGET</span></span> <br />
						<br />
				  <input name="txtuser" type="text" class="form-control" placeholder="Enter Username" style="width: 100%; height: 34px" id="txtuser" />&nbsp; </td>
			</tr>
			<tr>
				<td class="auto-style11" style="height: 12px">
				<input name="Submit1" style="width: 74px; font-weight: bold; font-size: large; font-family: 'Bernard MT Condensed';" type="submit" value="Submit" class="input btn-outline-danger" /><span class="auto-style14">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</span>
				<input name="Cancel" style="width: 74px; font-weight: bold; font-size: large; font-family: 'Bernard MT Condensed';" type="reset" value="Cancel"  class="input btn-outline-danger"/><br />
				</td>
			</tr>
			<tr>
