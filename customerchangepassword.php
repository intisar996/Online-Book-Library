	   ...
	   <br />
		...
		<table align="center" cellpadding="2" class="auto-style8" style="width: 39%; height: 241px">
			<tr class="auto-style10">
				<td class="auto-style7" style="height: 38px; " colspan="2">
				<strong>CHANGE PASSWORD</strong></td>
			</tr>
			<tr class="auto-style10">
				<td class="auto-style9" style="height: 38px; width: 576px">
				&nbsp;UserName :</td>
			...
			<tr>
				<td class="auto-style9" style="width: 576px">repate password :</td>
