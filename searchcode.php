...
$con=mysqli_connect("localhost","root","","dbsbook")or
...
if(empty($_POST['book_name'])&&  empty($_POST['quantity']) && $_POST['book_type']=='Select Book Type'  )
...
if(count($errors)==0)
{
$query="select * from tblbbook where book_name='$book_name 'or book_type='$book_type'or quantity='$quantity'";
...
echo "<h3><center>There are $n Record/s Matching Your Search</center></h3>";
	...
	echo "<table  id='productSizes' class='table' border='3'  style='width:50%;' align=center  cellspacing=2>";
	echo "<tr>";
	echo "<br>";
	echo "<tr bgcolor='#A52834'> ";

		echo "<td   width=100 align=center  colspan=9><font color='#ffffff'> BOOK</font></td>";
	echo"</tr>";
echo"<td  bgcolor='#C4D0DC'>BOOK ID</td>";
echo"<td  bgcolor='#C4D0DC'>BOOK Name</td>";
echo"<td  bgcolor='#C4D0DC'>BOOK Type</td>";
echo"<td bgcolor='#C4D0DC'>Quantity</td>";
echo"<td  colspan ='1' bgcolor='#C4D0DC'>Action</th>";
echo "</tr>";
...
while($row=mysqli_fetch_assoc($result))
{
 ...
 echo "<tr>";
 echo"<td><center>$book_id</center></td>";
 echo"<td><center>$book_name</center></td>";
 echo"<td><center>$book_type</center></td>";
 echo"<td><center>$quantity</center></td>";
  echo"<td><a href='updatebook1.php?book_id=$book_id'>UPDATE QUANTITY</a>";
